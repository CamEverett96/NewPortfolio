...
<body id="top" class="home__page">
   ...
   <?php require('includes/header.php');?>
    ...
    <!-- hero
    ================================================== -->
    <section id="hero" class="s-hero target-section" data-parallax="scroll" data-image-src="/" data-natural-width=800 data-natural-height=700 data-position-y=center>
